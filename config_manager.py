...
from __future__ import annotations          # ✅ اجازهٔ استفاده از annotationهای آینده (مانند | در تایپ‌ها)
...
#  - هر بخش توضیح داده شده است تا بدانید چه مقادیری می‌پذیرد و چرا
# ------------------------------
_DEFAULTS: Dict[str, Any] = {
    ...
    "kafka": {
        ...
        "topics": {
            ...
            "status": "clients.status"      # تاپیک وضعیت کلاینت‌ها (قابل فشرده‌سازی/compacted)
        }
    },
    "auth": {
    ...
    "executor": {
        ...
        "priority_levels": [0,1,2],         # سطوح اولویت (0=بالاترین)
