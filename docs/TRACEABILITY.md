...
| --- | --- | --- | --- | --- |
| One safe unattended MT5 runtime | ADR-001 (provisional) | B, H | #1, #14 | Session 1 direct-worker probe passed; direct service launch blocked at Window Station/Desktop access; unattended launch pending |
